...
The [source code](https://github.com/manfredsteyer/angular-ddd) of the case study used in this chapter can be found [here](https://github.com/manfredsteyer/angular-ddd).

## A Case Study

Let's consider a consumer travel web application. After applying the ideas of strategic design, we have identified several sub-domains:
